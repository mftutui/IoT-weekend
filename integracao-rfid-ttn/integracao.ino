...
// network initially.
static const PROGMEM u1_t NWKSKEY[16] = { 0x7C, 0x4B, 0xE9, 0x32, 0xB8, 0x43, 0x7E, 0x9E, 0x86, 0x6B, 0x81, 0x81, 0x7E, 0xAE, 0xCE, 0xA3 };

// LoRaWAN AppSKey, application session key
// This is the default Semtech key, which is used by the prototype TTN
// network initially.
static const u1_t PROGMEM APPSKEY[16] = { 0xC7, 0x01, 0x42, 0x83, 0x0C, 0x1F, 0x2F, 0x7E, 0x20, 0xBE, 0xF7, 0xAA, 0x67, 0x48, 0x39, 0xA6 } ;

// LoRaWAN end-device address (DevAddr)
// See http://thethingsnetwork.org/wiki/AddressSpace
static const u4_t DEVADDR = 0x26031009 ; // <-- Change this address for every node!
...
//NeoSWSerial rfid(rxPin,txPin); // Rx, Tx
...
//  Serial.begin(115200);  //Serial de Debug
//  Serial1.begin(115200); //Serial do módulo RFID - baud de 921600 porém para corrigir o desvio do cristal em 900000.
//
